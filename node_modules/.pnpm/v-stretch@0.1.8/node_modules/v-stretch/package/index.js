...
Vue.directive('stretch', {
  ...
  resize (oParent, handle, type) {
    handle.onmousedown = function (event) {
      ...
      // if (getCssNumber('paddingTop')) {
      //   oParent.style.top = style.paddingTop
      //   oParent.style.paddingTop = 0
      // }
      if (getCssNumber('marginTop')) {
        oParent.style.top = style.marginTop
        oParent.style.marginTop = 0
      }
      // if (getCssNumber('paddingLeft')) {
      //   oParent.style.left = style.paddingLeft
      //   oParent.style.paddingLeft = 0
      // }
      ...
      document.onmousemove = function (event) {
        ...
        const minW = 120  //设置拉伸最小宽度
        const minH = 80//设置拉伸最小高度
